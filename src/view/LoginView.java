...
public class LoginView extends JFrame {
    ...
    private JPanel buildLoginPanel() {
        ...
        btnCancel.addActionListener(e -> {
            if (cancelHandler != null) cancelHandler.accept(this);
            else System.exit(0);
        });
        south.add(btnCancel);
        ...
        // Key Bindings
        root.registerKeyboardAction(e -> btnLogin.doClick(), KeyStroke.getKeyStroke("ENTER"), JComponent.WHEN_IN_FOCUSED_WINDOW);
        root.registerKeyboardAction(e -> btnCancel.doClick(), KeyStroke.getKeyStroke("ESCAPE"), JComponent.WHEN_IN_FOCUSED_WINDOW);
    ...
    private static class RoundedPanel extends JPanel {
        ...
        private RoundedPanel(int arc, Color bg) { this.arc = arc; this.bg = bg; setOpaque(false); }
        ...
        @Override public Insets getInsets() { return new Insets(12,12,12,12); }
    }
}